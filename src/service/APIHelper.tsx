...
function instanceofIWord(object: IWord[] | IAggregateResult[] | [IWord[], IAggregateResult[]]): object is IWord[] {
...
export function statisticsAdapter(inputData: IStatisticsResult): IUserStatistics[] {
